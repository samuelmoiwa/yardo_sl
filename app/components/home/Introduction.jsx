...
const Introduction = () => {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-100 to-blue-50 dark:from-gray-900 dark:to-gray-800
        text-gray-900 dark:text-gray-100 py-20 px-6 md:px-16 overflow-hidden">
